...
|---|---|---|
| `ts/` | @voxgig-sdk/manual-precipitation-stations-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/manual-precipitation-stations-sdk \
      --repository voxgig-sdk/manual-precipitation-stations-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/manual-precipitation-stations-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/manual-precipitation-stations-sdk --id=<id>` removes one.
