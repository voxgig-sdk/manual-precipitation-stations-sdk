...
Then `npm trust list @voxgig-sdk/manual-precipitation-stations-sdk` shows it, and
`npm trust revoke @voxgig-sdk/manual-precipitation-stations-sdk --id=<id>` removes it.
