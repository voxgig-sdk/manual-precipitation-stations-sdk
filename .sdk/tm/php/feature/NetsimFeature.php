...
// ManualPrecipitationStations SDK netsim feature
...
class ManualPrecipitationStationsNetsimFeature extends ManualPrecipitationStationsBaseFeature
{
    ...
    private function _simulate(ManualPrecipitationStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ManualPrecipitationStationsContext $ctx, array $applied): void
    {
        $client = $this->client;
