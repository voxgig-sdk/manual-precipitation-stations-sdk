...
// ManualPrecipitationStations SDK proxy feature
...
class ManualPrecipitationStationsProxyFeature extends ManualPrecipitationStationsBaseFeature
{
    ...
    public function init(ManualPrecipitationStationsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ManualPrecipitationStationsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
