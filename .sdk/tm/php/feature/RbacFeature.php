...
// ManualPrecipitationStations SDK rbac feature
...
class ManualPrecipitationStationsRbacFeature extends ManualPrecipitationStationsBaseFeature
{
    ...
    private function _required(ManualPrecipitationStationsContext $ctx): ?string
    {
    ...
    private function _reject(ManualPrecipitationStationsContext $ctx, string $required): void
    {
    ...
    private function _track(ManualPrecipitationStationsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
