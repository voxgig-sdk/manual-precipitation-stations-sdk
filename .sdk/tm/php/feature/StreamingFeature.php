...
// ManualPrecipitationStations SDK streaming feature
...
class ManualPrecipitationStationsStreamingFeature extends ManualPrecipitationStationsBaseFeature
{
    ...
    private function _iterate(ManualPrecipitationStationsResult $result): \Generator
    {
    ...
    private function _streamable(ManualPrecipitationStationsContext $ctx): bool
    {
