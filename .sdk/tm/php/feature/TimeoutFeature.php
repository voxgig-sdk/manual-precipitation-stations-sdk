...
// ManualPrecipitationStations SDK timeout feature
...
class ManualPrecipitationStationsTimeoutFeature extends ManualPrecipitationStationsBaseFeature
{
    ...
    private function _with_timeout(ManualPrecipitationStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ManualPrecipitationStationsContext $_ctx, float $ms): void
    {
        $client = $this->client;
