...
// ManualPrecipitationStations SDK pipeline test
//
...
{
    private static function utility(): ManualPrecipitationStationsUtility
    {
        return new ManualPrecipitationStationsUtility();
    }
    ...
    private static function ctx(array $over = []): ManualPrecipitationStationsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ManualPrecipitationStationsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ManualPrecipitationStationsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ManualPrecipitationStationsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ManualPrecipitationStationsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ManualPrecipitationStationsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ManualPrecipitationStationsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ManualPrecipitationStationsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ManualPrecipitationStationsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ManualPrecipitationStationsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ManualPrecipitationStationsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ManualPrecipitationStationsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ManualPrecipitationStationsResponse([]),
            'result' => new ManualPrecipitationStationsResult([]),
        ]);
        [, $err] = ManualPrecipitationStationsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ManualPrecipitationStationsSpec([]),
            'response' => null,
            'result' => new ManualPrecipitationStationsResult([]),
        ]);
        [, $err] = ManualPrecipitationStationsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ManualPrecipitationStationsSpec(['step' => 's']),
            'response' => new ManualPrecipitationStationsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ManualPrecipitationStationsResult([]),
        ]);
        [, $err] = ManualPrecipitationStationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ManualPrecipitationStationsSpec(['step' => 's']),
            'response' => new ManualPrecipitationStationsResponse(self::resp(200, ['v' => 1])),
            'result' => new ManualPrecipitationStationsResult([]),
        ]);
        [, $err] = ManualPrecipitationStationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ManualPrecipitationStationsSpec(['step' => 's']),
            'response' => new ManualPrecipitationStationsResponse(self::resp(200, ['v' => 2])),
            'result' => new ManualPrecipitationStationsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ManualPrecipitationStationsMakeResponse::call($ctx);
    ...
    {
        $preset = new ManualPrecipitationStationsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ManualPrecipitationStationsSpec([]),
            'response' => new ManualPrecipitationStationsResponse([]),
            'result' => new ManualPrecipitationStationsResult([]),
        ...
        [$got, $err] = ManualPrecipitationStationsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ManualPrecipitationStationsResult([])]);
        [, $err] = ManualPrecipitationStationsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ManualPrecipitationStationsSpec([]), 'result' => null]);
        [, $err] = ManualPrecipitationStationsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ManualPrecipitationStationsSpec(['step' => 's']),
            'result' => new ManualPrecipitationStationsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ManualPrecipitationStationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ManualPrecipitationStationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ManualPrecipitationStationsSpec(['step' => 's']),
            'result' => new ManualPrecipitationStationsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ManualPrecipitationStationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ManualPrecipitationStationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ManualPrecipitationStationsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ManualPrecipitationStationsSpec([]),
            'result' => new ManualPrecipitationStationsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ManualPrecipitationStationsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ManualPrecipitationStationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ManualPrecipitationStationsError('boom', 'boom');
        $utility->fetcher = function (ManualPrecipitationStationsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ManualPrecipitationStationsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ManualPrecipitationStationsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ManualPrecipitationStationsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ManualPrecipitationStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ManualPrecipitationStationsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ManualPrecipitationStationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ManualPrecipitationStationsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ManualPrecipitationStationsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ManualPrecipitationStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ManualPrecipitationStationsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ManualPrecipitationStationsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ManualPrecipitationStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ManualPrecipitationStationsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ManualPrecipitationStationsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ManualPrecipitationStationsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ManualPrecipitationStationsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ManualPrecipitationStationsResult(['ok' => false])]);
        $this->expectException(ManualPrecipitationStationsError::class);
        ManualPrecipitationStationsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ManualPrecipitationStationsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ManualPrecipitationStationsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ManualPrecipitationStationsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ManualPrecipitationStationsBaseFeature();
        $b = new ManualPrecipitationStationsBaseFeature();
        ManualPrecipitationStationsFeatureAdd::call($ctx, $a);
        ManualPrecipitationStationsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ManualPrecipitationStationsBaseFeature
    {
        $f = new ManualPrecipitationStationsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ManualPrecipitationStationsFeatureAdd::call($ctx, self::named_feature('a'));
        ManualPrecipitationStationsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        ManualPrecipitationStationsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        ManualPrecipitationStationsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        ManualPrecipitationStationsFeatureAdd::call($ctx, $replace);
        ...
        ManualPrecipitationStationsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?ManualPrecipitationStationsSpec $spec): ManualPrecipitationStationsContext
    {
    ...
    private static function auth_bags(): ManualPrecipitationStationsSpec
    {
        return new ManualPrecipitationStationsSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        ManualPrecipitationStationsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ManualPrecipitationStationsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ManualPrecipitationStationsResponse(['headers' => null]),
            'result' => new ManualPrecipitationStationsResult([]),
        ]);
        ManualPrecipitationStationsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ManualPrecipitationStationsResultBody::call($ctx);
