...
class PipelineTest extends TestCase
{
    ...
    private static function auth_ctx(array $options, ?array $headers): ManualPrecipitationStationsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ManualPrecipitationStationsSpec(['headers' => $headers]),
        ]);
    }
