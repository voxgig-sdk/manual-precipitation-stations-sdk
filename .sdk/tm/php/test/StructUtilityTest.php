...
// ManualPrecipitationStations SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ManualPrecipitationStationsOmni::makeStructRunner(
    ...
    {
        return ManualPrecipitationStationsOmni::objmodel(ManualPrecipitationStationsOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return ManualPrecipitationStationsOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return ManualPrecipitationStationsOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ManualPrecipitationStationsOmni::structfix($now, Struct::undef()))
                        !== json_encode(ManualPrecipitationStationsOmni::structfix($val, Struct::undef()))) {
