...
class ManualPrecipitationStationsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ManualPrecipitationStationsSDK/1.0)';
    ...
    public static function call(ManualPrecipitationStationsContext $ctx, string $fullurl, array $fetchdef): array
    {
