...
// ManualPrecipitationStations SDK utility: make_options

class ManualPrecipitationStationsMakeOptions
{
    ...
    public static function call(ManualPrecipitationStationsContext $ctx): array
    {
        ...
        //
        // `ManualPrecipitationStationsSchema::optspec()` is built from the model:
        ...
        $optspec = ManualPrecipitationStationsSchema::optspec();
