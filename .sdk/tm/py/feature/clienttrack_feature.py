...
# are never clobbered.
class ManualPrecipitationStationsClienttrackFeature(ManualPrecipitationStationsBaseFeature):
    def __init__(self):
        super().__init__()
        self.version = "0.0.1"
    ...
    def _name(self):
        name = self.options.get("clientName") or "ManualPrecipitationStations-SDK"
