...
class StructUtilityTest < Minitest::Test
  def setup
    ...
    @runner       = ManualPrecipitationStationsOmni.make_runner(STRUCT_TEST_JSON_FILE, @client)
  ...
  def test_minor_stringify
    @runsetflags.call(@minor_spec["stringify"], {}, lambda { |vin|
      value = vin.key?("val") ? (vin["val"] == ManualPrecipitationStationsOmni::NULLMARK ? "null" : vin["val"]) : ""
