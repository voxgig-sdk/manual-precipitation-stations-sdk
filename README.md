...
This API provides access to the data generated by MeteoSwiss's manual precipitation monitoring network, which operates around 240 locations collecting daily rainfall and snow measurements.

Learn more about Manual Precipitation Stations at [opendatadocs.meteoswiss.ch/a-data-groundbased/a5-manual-precipitation-stations](https://opendatadocs.meteoswiss.ch/a-data-groundbased/a5-manual-precipitation-stations).

This is an unofficial SDK for the Manual Precipitation Stations public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| Python | `voxgig-sdk-manual-precipitation-stations-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/manual-precipitation-stations-sdk/tags) |
| PHP | `voxgig-sdk/manual-precipitation-stations-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/manual-precipitation-stations-sdk/tags) |
...
| Ruby | `voxgig-sdk-manual-precipitation-stations-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/manual-precipitation-stations-sdk/tags) |
| Lua | `voxgig-sdk-manual-precipitation-stations-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/manual-precipitation-stations-sdk/tags) |
...
$collections = $client->Collection()->list();
print_r(array_map(fn($item) => $item->data_get(), $collections));
```
