...
AQL-driven CLI and REPL for the ManualPrecipitationStations SDK. Positional arguments are
...
```sh
go build -o manual-precipitation-stations-cli ./...
```
...
./manual-precipitation-stations-cli load 1 collection
./manual-precipitation-stations-cli load '{id:1}' collection
