// Command ManualPrecipitationStations-cli is a CLI + REPL for the ManualPrecipitationStations SDK,
...
const prompt = "manual-precipitation-stations"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "collection item"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      MANUAL_PRECIPITATION_STATIONS_APIKEY (api key), MANUAL_PRECIPITATION_STATIONS_BASE (base url override)")
