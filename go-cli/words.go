...
func registerSDKWords(r *eng.Registry, client *sdk.ManualPrecipitationStationsSDK) {
...
func runOp(client *sdk.ManualPrecipitationStationsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
