// Command ManualPrecipitationStations-mcp is an MCP server exposing the ManualPrecipitationStations
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ManualPrecipitationStations_list  — list records of an entity
//	ManualPrecipitationStations_load  — load a single record of an entity
//
