...
type Args struct {
	Entity string         `json:"entity" jsonschema:"collection | item"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ManualPrecipitationStationsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "manual-precipitation-stations_list",
		Description: "List records from ManualPrecipitationStations. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "manual-precipitation-stations_load",
		Description: "Load a single record from ManualPrecipitationStations. " +
...
func runOp(client *sdk.ManualPrecipitationStationsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ManualPrecipitationStationsSDK, name string) (sdk.ManualPrecipitationStationsEntity, error) {
