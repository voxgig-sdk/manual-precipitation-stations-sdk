...
type ManualPrecipitationStationsSDK struct {
	Mode     string
...
func NewManualPrecipitationStationsSDK(options map[string]any) *ManualPrecipitationStationsSDK {
	sdk := &ManualPrecipitationStationsSDK{
		Mode:     "live",
		Features: []Feature{},
	}
...
func (sdk *ManualPrecipitationStationsSDK) OptionsMap() map[string]any {
...
func (sdk *ManualPrecipitationStationsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ManualPrecipitationStationsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ManualPrecipitationStationsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ManualPrecipitationStationsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ManualPrecipitationStationsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ManualPrecipitationStationsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ManualPrecipitationStationsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ManualPrecipitationStationsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ManualPrecipitationStationsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ManualPrecipitationStationsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ManualPrecipitationStationsSDK {
	...
	sdk := NewManualPrecipitationStationsSDK(sdkopts)
	sdk.Mode = "test"
