...
func TestCollectionEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set MANUAL_PRECIPITATION_STATIONS_TEST_COLLECTION_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func collectionBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("MANUAL_PRECIPITATION_STATIONS_TEST_COLLECTION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["MANUAL_PRECIPITATION_STATIONS_TEST_COLLECTION_ENTID"])
