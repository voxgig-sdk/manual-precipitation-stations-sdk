...
const testSeed = `map[string]any{"entity": map[string]any{"collection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "item": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
