...
function runner.env_override(m)
  local live = runner.getenv("MANUALPRECIPITATIONSTATIONS_TEST_LIVE")
  local override = runner.getenv("MANUALPRECIPITATIONSTATIONS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MANUALPRECIPITATIONSTATIONS_TEST_EXPLAIN")
