...
function runner.env_override(m)
  local live = runner.getenv("MANUAL_PRECIPITATION_STATIONS_TEST_LIVE")
  local override = runner.getenv("MANUAL_PRECIPITATION_STATIONS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MANUAL_PRECIPITATION_STATIONS_TEST_EXPLAIN")
