...
local function make_error_util(ctx, err)
  ...
  local msg = "ManualPrecipitationStationsSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = ManualPrecipitationStationsError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == ManualPrecipitationStationsError then
