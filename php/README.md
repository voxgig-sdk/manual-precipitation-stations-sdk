# ManualPrecipitationStations PHP SDK



The PHP SDK for the ManualPrecipitationStations API — an entity-oriented client using PHP conventions.
...
print_r(array_map(fn($item) => $item->data_get(), $item));
```
...
| Field | Type | Description |
| --- | --- | --- |
| `assets` | `array` | Assets associated with this item (e.g., CSV data file) |
| `features` | `array` |  |
| `geometry` | `array` | GeoJSON geometry of the station location |
| `id` | `string` |  |
| `links` | `array` |  |
| `numberMatched` | `int` |  |
| `numberReturned` | `int` |  |
...
The main class (`manualprecipitationstations_sdk.php`) exports the SDK class
