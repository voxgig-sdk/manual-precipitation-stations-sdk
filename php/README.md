...
The PHP SDK for the ManualPrecipitationStations API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Collection(null)->list(null, null);
...
[$result, $err] = $client->ManualPrecipitationStations(null)->load(
    ["id" => "test01"], null
);
