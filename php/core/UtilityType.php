...
// ManualPrecipitationStations SDK utility type

class ManualPrecipitationStationsUtility
{
    ...
    public static function copy(ManualPrecipitationStationsUtility $src): ManualPrecipitationStationsUtility
    {
        $u = new ManualPrecipitationStationsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
