...
// ManualPrecipitationStations SDK cache feature
...
class ManualPrecipitationStationsCacheFeature extends ManualPrecipitationStationsBaseFeature
{
    ...
    private function _through(ManualPrecipitationStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
