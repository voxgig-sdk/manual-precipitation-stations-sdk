...
// ManualPrecipitationStations SDK clienttrack feature
...
class ManualPrecipitationStationsClienttrackFeature extends ManualPrecipitationStationsBaseFeature
{
    ...
    public function PostConstruct(ManualPrecipitationStationsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ManualPrecipitationStations-SDK';
