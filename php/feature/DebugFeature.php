...
// ManualPrecipitationStations SDK debug feature
...
class ManualPrecipitationStationsDebugFeature extends ManualPrecipitationStationsBaseFeature
{
    ...
    private function _finish(ManualPrecipitationStationsContext $ctx, bool $ok): void
    {
