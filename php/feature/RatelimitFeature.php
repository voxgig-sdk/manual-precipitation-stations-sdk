...
// ManualPrecipitationStations SDK ratelimit feature
...
class ManualPrecipitationStationsRatelimitFeature extends ManualPrecipitationStationsBaseFeature
{
    ...
    private function _acquire(ManualPrecipitationStationsContext $ctx): void
    {
    ...
    private function _track(ManualPrecipitationStationsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
