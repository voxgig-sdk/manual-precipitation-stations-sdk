...
// ManualPrecipitationStations SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ManualPrecipitationStationsSDK::test)
...
{
    private const SDK_CLASS = 'ManualPrecipitationStationsSDK';
    ...
    private const SDK_BASE = 'manualprecipitationstations_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../manualprecipitationstations_sdk.php';
