...
// ManualPrecipitationStations SDK utility: graphql
//
...
class ManualPrecipitationStationsGraphql
{
    ...
    // equivalent.
    public static function body(ManualPrecipitationStationsContext $ctx): mixed
    {
    ...
    public static function errors(ManualPrecipitationStationsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
