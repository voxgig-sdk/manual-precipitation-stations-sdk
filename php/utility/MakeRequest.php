...
// ManualPrecipitationStations SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ManualPrecipitationStationsMakeRequest
{
    public static function call(ManualPrecipitationStationsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ManualPrecipitationStationsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ManualPrecipitationStationsResponse($fetched);
        } else {
