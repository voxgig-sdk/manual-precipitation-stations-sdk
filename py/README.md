# ManualPrecipitationStations Python SDK



The Python SDK for the ManualPrecipitationStations API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Collection()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/manual-precipitation-stations-sdk/releases)) or
...
| Field | Type | Description |
| --- | --- | --- |
| `assets` | `dict` | Assets associated with this item (e.g., CSV data file) |
| `features` | `list` |  |
| `geometry` | `dict` | GeoJSON geometry of the station location |
| `id` | `str` |  |
| `links` | `list` |  |
| `numberMatched` | `int` |  |
| `numberReturned` | `int` |  |
