# ManualPrecipitationStations Python SDK Reference

Complete API reference for the ManualPrecipitationStations Python SDK.
...
#### `ManualPrecipitationStationsSDK.test(testopts=None, sdkopts=None)`
