...
from manualprecipitationstations_sdk.utility import register

# Load features
from manualprecipitationstations_sdk.feature.base_feature import ManualPrecipitationStationsBaseFeature
from manualprecipitationstations_sdk.features import _has_feature, _make_feature
...
class ManualPrecipitationStationsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ManualPrecipitationStationsUtility()
        self._utility = utility

        from manualprecipitationstations_sdk.config import shared_config
    ...
    def get_utility(self):
        return ManualPrecipitationStationsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ManualPrecipitationStationsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Collection(self, data=None) -> "CollectionEntity":
        ...
        from manualprecipitationstations_sdk.entity.collection_entity import CollectionEntity
        return CollectionEntity(self, data)


    def Item(self, data=None) -> "ItemEntity":
        """Entity factory: client.Item().list() / client.Item().load({"id": ...})."""
        from manualprecipitationstations_sdk.entity.item_entity import ItemEntity
