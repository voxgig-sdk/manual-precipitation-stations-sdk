...
from manualprecipitationstations_sdk.core.control import ManualPrecipitationStationsControl
...
from manualprecipitationstations_sdk.core.helpers import get_ctx_prop, to_map
...
class ManualPrecipitationStationsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ManualPrecipitationStationsControl()
        ...
        if isinstance(sp, ManualPrecipitationStationsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ManualPrecipitationStationsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ManualPrecipitationStationsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ManualPrecipitationStationsOperation({})
    ...
    def make_error(self, code, msg):
        return ManualPrecipitationStationsError(code, msg, self)
