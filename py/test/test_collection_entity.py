...
class TestCollectionEntity:
    ...
    def test_should_create_instance(self):
        testsdk = ManualPrecipitationStationsSDK.test(None, None)
    ...
    def test_should_stream(self):
        ...
        base = ManualPrecipitationStationsSDK.test(seed, None)
    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set MANUAL_PRECIPITATION_STATIONS_TEST_COLLECTION_ENTID JSON to run live")
        client = setup["client"]
...
def _collection_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("MANUAL_PRECIPITATION_STATIONS_TEST_COLLECTION_ENTID"))
