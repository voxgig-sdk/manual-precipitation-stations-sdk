# ManualPrecipitationStations SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ManualPrecipitationStationsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ManualPrecipitationStationsSDK(...) and ManualPrecipitationStationsSDK.test(...) become
#      ManualPrecipitationStationsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "manualprecipitationstations_sdk"
_SDK_CLASS = "ManualPrecipitationStationsSDK"
