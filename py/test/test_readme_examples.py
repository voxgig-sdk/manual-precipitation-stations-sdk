# ManualPrecipitationStations SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from manualprecipitationstations_sdk import ManualPrecipitationStationsSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"ManualPrecipitationStationsSDK": ManualPrecipitationStationsSDK, "os": os}
        try:
