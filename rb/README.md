...
The Ruby SDK for the ManualPrecipitationStations API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.ManualPrecipitationStations(nil).load(
  { "id" => "test01" }, nil
)
