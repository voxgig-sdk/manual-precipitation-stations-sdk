# ManualPrecipitationStations SDK Collection entity
...
class CollectionEntity
  ...
  # @return [Array<Collection>, Array] the matching Collection items; raises ManualPrecipitationStationsError on failure
