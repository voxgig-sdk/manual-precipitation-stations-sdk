# ManualPrecipitationStations SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # ManualPrecipitationStationsSDK.new, not ManualPrecipitationStationsSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    ManualPrecipitationStationsSDK.new(opts)
  end
