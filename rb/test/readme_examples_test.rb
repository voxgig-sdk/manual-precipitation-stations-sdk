...
#      offline in seeded test mode (ManualPrecipitationStationsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ManualPrecipitationStations_sdk.rb")
  SDK_CLASS = "ManualPrecipitationStationsSDK"
  ...
  SDK_BASE = "ManualPrecipitationStations_sdk"
