...
| `tester(testopts?, sdkopts?)` | `ManualPrecipitationStationsSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ManualPrecipitationStationsSDK.test(testopts?, sdkopts?)` | `ManualPrecipitationStationsSDK` | Create a test-mode client. |
...
| `client` | `client(): ManualPrecipitationStationsSDK` | Return the parent SDK client. |
...
| Field | Type | Description |
| --- | --- | --- |
| `assets` | `Record<string, any>` | Assets associated with this item (e.g., CSV data file) |
| `features` | `any[]` |  |
| `geometry` | `Record<string, any>` | GeoJSON geometry of the station location |
| `id` | `string` |  |
| `links` | `any[]` |  |
...
├── src/
│   ├── ManualPrecipitationStationsSDK.ts        # Main SDK class
