# ManualPrecipitationStations TypeScript SDK Reference

Complete API reference for the ManualPrecipitationStations TypeScript SDK.
...
```ts
new ManualPrecipitationStationsSDK(options?: object)
```
...
#### `ManualPrecipitationStationsSDK.test(testopts?, sdkopts?)`
...
**Returns:** `ManualPrecipitationStationsSDK` instance in test mode.
...
Alias for `ManualPrecipitationStationsSDK.test()`.
...
Return the parent `ManualPrecipitationStationsSDK` instance.
