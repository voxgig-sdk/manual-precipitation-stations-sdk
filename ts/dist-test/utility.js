...
function envOverride(m) {
    if ('TRUE' === process.env.MANUAL_PRECIPITATION_STATIONS_TEST_LIVE ||
        'TRUE' === process.env.MANUAL_PRECIPITATION_STATIONS_TEST_OVERRIDE) {
    ...
    m.MANUAL_PRECIPITATION_STATIONS_TEST_EXPLAIN = process.env.MANUAL_PRECIPITATION_STATIONS_TEST_EXPLAIN || m.MANUAL_PRECIPITATION_STATIONS_TEST_EXPLAIN;
    return m;
}
