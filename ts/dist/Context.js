...
const ManualPrecipitationStationsError_1 = require("./ManualPrecipitationStationsError");
...
class Context {
    ...
    error(code, msg) {
        return new ManualPrecipitationStationsError_1.ManualPrecipitationStationsError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
