...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MANUALPRECIPITATIONSTATIONS_TEST_LIVE ||
    'TRUE' === process.env.MANUALPRECIPITATIONSTATIONS_TEST_OVERRIDE
  ) {
  ...
  m.MANUALPRECIPITATIONSTATIONS_TEST_EXPLAIN = process.env.MANUALPRECIPITATIONSTATIONS_TEST_EXPLAIN || m.MANUALPRECIPITATIONSTATIONS_TEST_EXPLAIN
